...
<template>
  <footer class="bg-[#0B1121] text-white">
    <!-- CTA Section -->
          ...
          <div class="md:col-span-6 flex flex-col gap-6 md:pl-12">
            ...
            <form @submit.prevent="onSubmit" class="relative max-w-md">
              <UInput
                ...
                class="w-full"
                :ui="{
                  base: 'w-full py-3 pl-4 pr-28 bg-[#161F32] border-white/10 text-white placeholder-gray-500 focus:ring-primary-500 focus:border-primary-500 rounded-lg'
                }"
                variant="none"
              >
                <template #trailing>
